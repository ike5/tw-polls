...
function Stats() {
  ...
  useEffect(() => {
    ...
    fetch("http://localhost:3347/insights", requestOptions)
    ...
    <div className="">
      <div className="stats shadow flex">
        <div className="stat">
          ...
          <div className="stat-desc">
            {((kickValues / totalVotes) * 100).toFixed(0)}%
          </div>
        </div>
        ...
        <div className="stat">
          ...
          <div className="stat-desc">
            {((audioValues / totalVotes) * 100).toFixed(0)}%
          </div>
        </div>
        ...
        <div className="stat">
          ...
          <div className="stat-desc">
            {((videoValues / totalVotes) * 100).toFixed(0)}%
          </div>
        </div>
      </div>
      ...
      <div className="stats shadow flex">
        <div className="stat">
          ...
          <div className="stat-desc">
            {((freezeValues / totalVotes) * 100).toFixed(0)}%
          </div>
        </div>
